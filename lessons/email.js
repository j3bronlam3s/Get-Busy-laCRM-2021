function validateEmail(){
    let tlds = [".aero",".biz",".cat",".com",".coop",".edu",".gov",".info",".int",".jobs",".mil",".mobi",".museum",
    ...
    let alerts = ['Please enter your email', 'Your email did not include an @', 'Your email is too short', 'Your email does not contain a valid TLD (.com/.net/etc.)', 'Your email is valid']
    let user = [];
    let email = document.getElementById("email").value
    let valid = false
    tlds.forEach(element => {
