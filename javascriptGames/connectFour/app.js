...
function checkBoard(){
    ...
    for(let y = 0; y<winningArray.length; ++y) {
        ...
        //check if player class is the same
...
//add eventListener for checkBoard()
squares.forEach(element => element.addEventListener('click', checkBoard));
